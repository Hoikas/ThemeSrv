...
THEME_NET_STRUCT_BEGIN_COMMON(common, encrypt_header)
    THEME_NET_FIELD_UINT8(msgId)
    THEME_NET_FIELD_UINT8(bufsz)
THEME_NET_STRUCT_END(common, encrypt_header)

THEME_NET_STRUCT_BEGIN_COMMON(common, encrypt_s2c)
    THEME_NET_FIELD_UINT8(msgId)
    THEME_NET_FIELD_UINT8(bufsz)
    THEME_NET_FIELD_BLOB(srvSeed, 7)
THEME_NET_STRUCT_END(common, encrypt_s2c)
